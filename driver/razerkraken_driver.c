...
#include <linux/module.h> #include <linux/init.h> #include <linux/usb/input.h>
#include <linux/hid.h>
...
static ssize_t razer_attr_read_device_type(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    case USB_DEVICE_ID_RAZER_KRAKEN_V2_KITTY_EDITION:
	device_type = "Razer Kraken 7.1 V2 Kitty Edition\n";
	break;
...
static const struct hid_device_id razer_devices[] = {
    ...
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_KRAKEN_V2_KITTY_EDITION) },
    { 0 }
};
